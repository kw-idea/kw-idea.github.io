...
2025.09 - 2026.08  공간 적응형 Wi-Fi 기반 비접촉 방식의 활동 인식 시스템 및 평가 프레임워크: 보행 사례를 중심으로 (한국연구재단, 우수신진)

2025.09 - 2026.08  스마트 AI 음성 제어 로봇 이젤 개발 (서울경제진흥원, 건융아이비씨)

2024.10 - 2025.09  뇌병변 장애인 재활체육을 위한 AI 트레이너 앱 개발 (중소벤처기업부, 좋은운동장)

2024.06 - 2025.05  협업 생산성과 프라이버시 간 갈등 해소를 위한 대안적 협업 도구 설계 연구 (한국연구재단, 우수신진)
